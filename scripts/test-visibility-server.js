...
app.get("/api/check-visibility", (req, res) => {
  console.log(
    `[${new Date().toISOString()}] Visibility check requested - Current state: ${isVisible}`,
  );
...
app.post("/api/toggle-visibility", (req, res) => {
  isVisible = !isVisible;
  console.log(
    `[${new Date().toISOString()}] Visibility toggled to: ${isVisible}`,
  );
...
app.listen(PORT, () => {
  ...
  console.log(
    `   Check Visibility: http://localhost:${PORT}/api/check-visibility`,
  );
  console.log(
    `   Toggle Visibility: POST http://localhost:${PORT}/api/toggle-visibility`,
  );
  console.log(
    `   Set Visibility: POST http://localhost:${PORT}/api/set-visibility`,
  );
  ...
  console.log(
    `  --checking-url http://localhost:${PORT}/api/check-visibility \\`,
  );
